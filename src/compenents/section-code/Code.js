...
export default function Code(){
    return (
        <section className="mb-20 lg:mb-0 p-4 bg-black border-2 border-teal font-display text-sm md:text-lg leading-loose shadow" style={{ flexBasis: '100%' }}>
            ...
            <p><span className="text-dark">10</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-yellow">'<Link rel="noopener noreferrer" className="underline" target="_blank" to="https://wwww.react.dev">React JS</Link>'</span>,</p>
